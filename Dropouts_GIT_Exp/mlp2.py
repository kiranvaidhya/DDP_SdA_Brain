...
def test_mlp(
    ...
    cost = classifier.negative_log_likelihood(y) + 0.00001 * classifier.L2_sqr
    dropout_cost = classifier.dropout_negative_log_likelihood(y) + 0.00001 * classifier.L2_sqr
    ...
    while epoch_counter < n_epochs:
        ...
        # adaptive_lr = initial_learning_rate / ( 1 + 5e-05 * epoch_counter)
